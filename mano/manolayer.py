...
from mano.mano_utils import ready_arguments, batch_rodrigues, th_posemap_axisang, th_with_zeros, subtract_flat_id, \
                            robust_compute_rotation_matrix_from_ortho6d, compute_rotation_matrix_from_ortho6d, batch_rotprojs
    ...
    def forward(self,
        ...
        if self.use_pca or self.joint_rot_mode == 'axisang':
            ...
            if self.root_rot_mode == 'axisang':
                ...
                if self.robust_rot:
                    root_rot = robust_compute_rotation_matrix_from_ortho6d(th_full_pose[:, :6])
                else:
                    root_rot = compute_rotation_matrix_from_ortho6d(th_full_pose[:, :6])
        else:
